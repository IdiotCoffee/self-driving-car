...
class Car:
    ...
    def update(self, delta_time):
        ...
        if self.is_running:
            ...
            print(f"Radar Inputs: {[self.probe(radar) for radar in self.radars]}")
            print(f"Normalized Inputs: {measurements}")
            print(f"NN Output: acceleration={acceleration}, steer={steer_position}")
